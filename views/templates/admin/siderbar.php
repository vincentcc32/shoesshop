<aside class="sidebar-nav-wrapper">
    <div class="navbar-logo">
        <h1 class="fs-3 fw-bold text-gray text-uppercase text-center">ADMIN</h1>
    </div>
    <nav class="sidebar-nav">
        <ul>
            <li class="nav-item active">
                <a href="admin.php" class="active"> <span class="icon">
            ...
            <li class="nav-item nav-item-has-children">
                <a class="collapsed cursor-pointer" data-bs-toggle="collapse" data-bs-target="#ddmenu_2" aria-controls="ddmenu_2"
            ...
            <li class="nav-item nav-item-has-children">
                <a class="collapsed cursor-pointer" data-bs-toggle="collapse" data-bs-target="#ddmenu_3" aria-controls="ddmenu_3"
                    aria-expanded="false" aria-label="Toggle navigation">
                    <span class="icon">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <ul id="ddmenu_3" class="collapse dropdown-nav">
                    <li>
                        <a href="admin.php?ctrl=user&view=usermanagement"> Users </a>
                    </li>
                    <li>
                        <a href="admin.php?ctrl=user&view=adminmanagement"> Admin </a>
                    </li>
                </ul>
            </li>
            <?php if ($_SESSION['user']['UserID'] === "1"): ?>
                <li class="nav-item active">
                    <a href="admin.php?ctrl=user&view=register" class="active">
                        <span class="icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <li class="nav-item">
                <a href="admin.php?ctrl=product&view=orderhistory" class="active"> <span class="icon">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <li class="nav-item">
                <a href="admin.php?ctrl=product&view=chat" class="active"><span class="icon">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item">
                <a href="admin.php?ctrl=product&view=notif">
                    <span class="icon">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
